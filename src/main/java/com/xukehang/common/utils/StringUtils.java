package com.xukehang.common.utils;
...
/**
 * @author 作者:xukehang
 * @version 创建时间：2019年9月9日 下午7:05:36 类功能说明
 */
public class StringUtils {
	/**
	 * 依赖日考工具包工程中添加 toHtml ()，方法，用于将前端<textarea>框 中的传来的字符转成 html 文本，遇到“\n”符时，要用
	 * <p>
	 * </p>
	 * 将这一段 字符包起来
	 * 
	...
	public static boolean isTelephone(String str) {
		String pattern = "^(136|135|137|157|187|158|176)\\d{8}$";
